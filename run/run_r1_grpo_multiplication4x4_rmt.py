...
from trl.models.modeling_amt.language_modeling import AssociativeMemoryCell, AssociativeRecurrentWrapper
...
def build_rmt(model_name, ckpt_path):
...
def grpo_function(
    ...
    trainer = GRPOTrainer(
        model=build_rmt(model_args.model_name_or_path, script_args.ckpt_path),
