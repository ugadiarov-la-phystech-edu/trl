...
class ScriptArguments:
    dataset_id_or_path: str = "elfray/multiplication_2x2"
...
SYSTEM_PROMPT = """
Step by step, multiply the numbers. For each place value of the multiplier, provide the partial products, the partial sums, and the final result in your response. For example, for the multiplication 81 * 45, the expected response is:
<step>81 * 5 = 405</step>
<step>81 * 40 = 3240</step>
<step>405 + 3240 = 3645</step>
<answer>3645</answer>
"""
